...
#define R_RX_PAYLOAD 0x61 // 0110_0001 bin
#define W_TX_PAYLOAD 0xA0 // 1010_0000 bin
#define FLUSH_TX 0xE1 // 1110_0001 bin
#define FLUSH_RX 0xE2 // 1110_0010 bin
#define REUSE_TX_PL 0xE3 //  1110_0011 bin
#define R_RX_PL_WID 0x60 // 0110_0000 bin
#define W_ACK_PAYLOAD(pipe) (0xA8 | pipe) // 1010_1PPP
#define W_TX_PAYLOAD_NOACK 0xB0 // 1011_0000
#define NOP 0xFF
